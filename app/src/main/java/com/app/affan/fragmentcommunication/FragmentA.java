...
public class FragmentA extends Fragment  implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button passDataButton = (Button) mView.findViewById(R.id.pass_text_button);
    ...
    public void onClick(View view) {
        ...
        if(view.getId() == R.id.pass_text_button){

            editText = (EditText) mView.findViewById(R.id.string_to_pass);

            if(editText.getText().toString().length() == 0){

                Toast.makeText(getContext(),"No Text",Toast.LENGTH_SHORT).show();
            }else {
                mListener.sendData(editText.getText().toString());
            }
        }
