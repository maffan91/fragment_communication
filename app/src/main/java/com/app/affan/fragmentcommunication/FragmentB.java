...
public class FragmentB extends Fragment {
    ...
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
     static final String ARG_PARAM1 = "passed_text";
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onFragmentBInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentBInteractionListener) {
            ...
            throw new RuntimeException(context.toString()
                    + " must implement OnFragmentBInteractionListener");
        }
    }
    ...
    public void setData(String string){
        ...
        textView = (TextView) mView.findViewById(R.id.passed_text);
    ...
    public interface OnFragmentBInteractionListener {
        ...
        void onFragmentBInteraction(Uri uri);
    }
    ...
    public void onStart() {
        ...
        if(args != null){
            ...
            updateString(args.getString(ARG_PARAM1));
